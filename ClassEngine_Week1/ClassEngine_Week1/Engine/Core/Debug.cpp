...
void Debug::SetSeverity(const MessageType type_)
{
	currentSev = type_;
}
...
{
	Log(MessageType::TYPE_FATAL_ERROR, "[FATAL]: " + message_, fileName_, line_);
	//Log(MessageType::TYPE_FATAL_ERROR, "[FATAL][f:" + fileName_ + "][l:" + line_ + "]: " + message_, fileName_, line_);

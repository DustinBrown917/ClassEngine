...
public:
	Debug() = delete;
	Debug(const Debug&) = delete; //Disable copy constructor lvalue
	Debug(Debug&&) = delete; //Disable move constructor lvalue
	Debug& operator = (const Debug&) = delete; //Disable copy constructor rvalue
	Debug& operator = (Debug&&) = delete; //Disable move constructor rvalue

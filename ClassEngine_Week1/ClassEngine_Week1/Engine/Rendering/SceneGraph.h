...
{
public:
	SceneGraph(const SceneGraph&) = delete; //Disable copy constructor lvalue
	SceneGraph(SceneGraph&&) = delete; //Disable move constructor lvalue
	SceneGraph& operator = (const SceneGraph&) = delete; //Disable copy constructor rvalue
	SceneGraph& operator = (SceneGraph&&) = delete; //Disable move constructor rvalue
	...
	void Update(const float deltaTime__);
